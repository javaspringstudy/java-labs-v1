...
public class MemoryLab {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("dulyAge = %d\n", dulyAge);
        System.out.printf("haniAge = %d\n", haniAge);
        
        
        // TODO: 참조 타입 변수 두 개를 선언하고, 하나를 다른 하나에 할당한 후
        // 참조된 객체의 값을 변경했을 때 어떤 일이 발생하는지 관찰하세요.
        String dulyName = new String("둘리");
        String haniName = new String("하니");

        dulyName = haniName;

        System.out.printf("dulyName = %s\n", dulyName);
        System.out.printf("haniName = %s\n", haniName);
        ...
        System.out.println("메소드 호출후 출력 score = " + score);//값 변화없음

        
        
        // TODO: 참조 타입 변수를 선언하고 메소드에 전달한 후
        // 메소드 내에서 참조된 객체의 값을 변경하고 메소드 호출 전후의 값을 비교하세요.
        Person duly = new Person("둘리", 99);
        modifyObject(duly);

        System.out.println("메소드 호출후 출력 duly = " + duly.toString());
    ...
    public static void modifyValue(int value) {
        ...
        value = 50;
        System.out.println("메소드 매개변수 값 변경후 출력 value = " + value);
    }
    ...
    public static void modifyObject(Person person) {
        ...
        person.setName("하니");
        person.setAge(15);
        System.out.println("메소드 매개변수 값 변경후 출력 person = " + person.toString());
    }
}
